...
public:
    ...
    public:
        ...
        int success_quadrilaterals = 5;
        float sample_dispersion = 0.5;
...
protected:
    ...
    std::mt19937 _point_index_engine;
...
protected :
    ...
    bool SelectRandomTriangle(int& base1, int& base2, int& base3, std::vector<int> &sample_pool);
