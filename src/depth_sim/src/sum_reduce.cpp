...
const std::string kSumScoreVertFile =  ros::package::getPath("bowen_depth_sim") +
                              "/src/sum_score.vert";
const std::string kSumScoreFragFile =  ros::package::getPath("bowen_depth_sim") +
                              "/src/sum_score.frag";
