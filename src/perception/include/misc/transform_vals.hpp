...
inline arma::vec linearTransform(const arma::vec& vals_inp, const arma::uvec& bounds_type, const arma::vec& lower_bounds, const arma::vec& upper_bounds)
{
    return (vals_inp-lower_bounds) / (upper_bounds-lower_bounds + 1e-20);
};


//@vals_trans_inp: range (0,1)
inline arma::vec invLinearTransform(const arma::vec& vals_trans_inp, const arma::uvec& bounds_type, const arma::vec& lower_bounds, const arma::vec& upper_bounds)
{
    return vals_trans_inp*(upper_bounds-lower_bounds) + lower_bounds;
};